        ...
        
    {
        protected override void Seed(MenuItemEntities context)
        {
            new List<MenuItem>
            {
                ...
                new MenuItem { ItemId = 11, ItemType = "Main", ItemName = "Yeto's Soup", ItemDescription = "All Zelda fans who've played Twilight Princess have had to wonder what Yeto the yeti's soup tastes like... give our version a try and see if it brings your strength back just like Yeto's!", ItemIconUrl = "/Assets/images/YetosSoupcon.jpg", ItemImageUrl = "/Assets/images/YetosSoupFull.jpg", ItemPrice = 10.99M },
